...
interface TypificationPieChartProps {
  data: LabelCount[];
}

export function TypificationPieChart({ data }: TypificationPieChartProps) {
  ...
  return (
    <Card>
      <CardHeader className="pb-2">
        <CardTitle className="text-sm font-medium">Tipificacion</CardTitle>
        <p className="text-xs text-muted-foreground">
          Como se cerraron las conversaciones
        </p>
      </CardHeader>
      <CardContent>
        <ChartContainer
